...
const PRECACHE_URLS = [
  ...
  "./assets/background_clouds_day.png",
  "./assets/background_clouds_sunset.png",
  "./assets/background_clouds_night.png",
  "./assets/background_clouds_sunrise.png",
  ...
  "./assets/background_plants_day.png",
  "./assets/background_plants_sunset.png",
  ...
  "./assets/pillar_column_day.png",
  "./assets/pillar_column_sunset.png",
  "./assets/pillar_column_night.png",
  "./assets/pillar_column_sunrise.png",
